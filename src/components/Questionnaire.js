    ...
    return (
      <div>
        ...
        >
          ...
          {/*-- Eligible? --*/}
          <fieldset>
            <legend>Have you worked in the last year?</legend>
          ...
          <fieldset className="set">
            <legend>Sorry, you are not eligible</legend>
          </fieldset>
                            ...
                            <fieldset className="set">
                              ...
                              <fieldset className="set">
                                ...
                                <fieldset className="set">
                                  ...
                                  <fieldset>
                                    <label
                                      htmlFor="radioHCHide10"
                                      className="btn"
                                    >
                                      -
                                    </label>
                                    <label
                                      htmlFor="radioHCShow10"
                                      className="btn"
                                    >
                                      +
                                    </label>
                            ...
                            <fieldset className="set">
                              ...
                              <fieldset className="set">
                                ...
                                <fieldset>
                                  <legend />
                                  <label
                                    htmlFor="radioMedHide9"
                                    className="btn"
                                  >
                                    -
                                  </label>
                                  <label
                                    htmlFor="radioMedShow9"
                                    className="btn"
                                  >
                                    +
                                  </label>
                                ...
                                <fieldset className="set">
                                  ...
                                  <fieldset>
                                    <legend />
                                    <label
                                      htmlFor="radioMedHide10"
                                      className="btn"
                                    >
                                      -
                                    </label>
                                    <label
                                      htmlFor="radioMedShow10"
                                      className="btn"
                                    >
                                      +
                                    </label>
